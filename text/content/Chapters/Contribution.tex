...
In our experimental evaluation, we observed that \textsc{SharpSAT-TD}
consistently outperformed \textsc{C2D} and \textsc{D4} in both compilation time
and circuit size, across a range of argumentation instances. This finding is
aligned with our expectations and previous studies in the literature
\citep{EITER2024104109, kiesel2023knowledge}. The superior performance of
\textsc{SharpSAT-TD} can be attributed to its advanced top-down compilation
techniques, where \textsc{C2D} stands as a robust, but older alternative, and
\textsc{D4} shows competitive performance in certain scenarios but generally
lags behind the other two compilers.

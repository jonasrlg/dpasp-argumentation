...
a Neuro-Symbolic approach, either using Integer Programming or Probabilistic
Logic Programming (PLP). While Integer Programming is a well-known mathematical
...
meio de uma abordagem Neuro-Simbólica, utilizando Programação Inteira ou
Programação Lógica Probabilística (PLP). Enquanto a Programação Inteira é uma

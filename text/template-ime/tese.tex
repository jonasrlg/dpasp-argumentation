...
\title{Argumentation modeling using probabilistic answer set programs}[]
\translatedtitle{Modelagem de argumentação usando programas de conjuntos de respostas probabilísticas}[]
...
\fichacatalografica{\input{../thesis/Chapters/Cataloguing.tex}}
...
\input{../thesis/Chapters/Acknowledgments.tex}
...
\input{../thesis/Chapters/Abstract.tex}
...
\pagestyle{mainmatter}
\input{../thesis/Chapters/PASP.tex}
\input{../thesis/Chapters/Circuits.tex}
\input{../thesis/Chapters/Literature.tex}
\input{../thesis/Chapters/Contribution.tex}

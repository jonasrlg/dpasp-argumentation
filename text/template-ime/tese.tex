...
\makeatletter
\AtBeginDocument{%
  \@ifundefined{listingscaption}{}{%
    \renewcommand{\listingscaption}{\lstlistingname}%
  }%
  \@ifundefined{listoflistingscaption}{}{%
    \renewcommand{\listoflistingscaption}{\programlistname}%
  }%
}
\makeatother
...
\title{Argumentation Mining with Probabilistic ASP}[]
\translatedtitle{Mineração de argumentos usando programas de conjuntos de respostas probabilísticas}[]

\author[fem]{Jonas Rodrigues Lima Gonçalves}

\def\profa{Prof\kern.02em.\kern-.07em\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11em\kern.07em}

% Para TCCs, este comando define o supervisor
\orientador[fem]{Prof. Dr. Denis Deratani Mauá}
...
%\banca{
%  \profa{} \dra{} Denis Deratani Mauá - IME-USP,
...
\fichacatalografica{\input{../content/Chapters/Cataloguing.tex}}
...
\input{../content/Chapters/Acknowledgments.tex}
...
\input{../content/Chapters/Abstract.tex}
...
\chapter*{Lista of Abbreviations}
...
\begin{tabular}{rl}
    ...
    % ADR & Annotated Disjunctive Rules \\
    % AI & Artificial Intelligence \\
    AMC & Algebraic Model Counting \\
    ASC & Answer Set Counting \\
    % ASEO & Answer Set Enumeration in the order of Optimality \\
    % AS & Answer Set \\
    BDD & Binary Decision Diagram \\
    % BN & Bayesian Network \\
    % BU & Bottom-Up \\
    % CC & Circuit Complexity \\
    % CCDD & Constrained Conjunction and Decision Diagram \\
    ...
    NP & Nondeteriministic Polynomial Time \\
    OBDD & Ordered Binary Decision Diagram \\
    % OptP & Optimization Polynomial Time \\
    PASP & Probabilistic Answer Set Programming \\
    % PbL & ProbLog \\
    PC & Probabilistic Circuit \\
    % PI & Probabilistic Inference \\
    % PL & Prolog \\
    ...
    % Sharp-P & Sharp Polynomial Time \\
    % Sharp-SAT & Sharp Satisfiability Problem \\
...
\begin{tabular}{rl}
    $X, Y, Z, \ldots$ & Sets of variables \\
    $x, y, z, \ldots$ & Sets of assignments \\
    $\braket{f}$ & Semantics of Boolean formula $f$ \\
    $f \equiv g$ & Equivalence between Boolean formulae $f$ and $g$ (i.e. $\braket{f} = \braket{g}$) \\
...
% Esta lista é criada automaticamente para os floats do tipo "listing"
% Você pode escolher se quer ou não permitir a quebra de página
\clearpage
\disablenewpage{\listoflistings}
...
\pagestyle{mainmatter}
\input{../content/Chapters/Sat.tex}
\input{../content/Chapters/AMC.tex}
\input{../content/Chapters/ASP.tex}
